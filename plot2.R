...
png(filename = "assignment1/ExData_Plotting1/plot2.png", width = 480, height = 480, units = "px")
plot(sub_hpc$DateTime,sub_hpc$Global_active_power,type="l" , ylab="Global Active Power (kilowatts)",xlab = NA)
dev.off()